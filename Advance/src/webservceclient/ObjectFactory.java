 ...
 * generated in the webservceclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetMessageResponse_QNAME = new QName("http://webservce/", "getMessageResponse");
    private final static QName _GetMessage_QNAME = new QName("http://webservce/", "getMessage");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: webservceclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservce/", name = "getMessageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservce/", name = "getMessage")
